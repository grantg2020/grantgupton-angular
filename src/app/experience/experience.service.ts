...
export class ExperienceService {
  private experiences = [
    ...
    },
    {
      ...
      description: [
        'Collaborated with other Computer Science students to review existing app code',
    ...
    },
    {
      ...
      description: [
        'Developed a reference website for continuing care retirement communities using Oracle APEX',
    ...
    },
    {
      ...
      projectUrls: [],
      description: [
        'Debugged client projects solving issues with e-commerce websites in Adobe Magento using HTML, CSS, LESS, JavaScript, PHP, and MySQL',
    ...
    },
    {
      ...
      projectUrls: [],
      description: [
        'Taught students from 6-15 years old in Python, HTML, CSS, JavaScript, and Lua through weekly summer camp',
    ...
    },
    {
      ...
      projectUrls: [],
      description: [
        'Debugged website code for the electrical and computer engineering department at NC State',
    ...
    },
    {
      ...
      projectUrls: [],
      description: [
        'Developed mobile application for iOS and Android in Flutter (Dart)',
    ...
    },
    {
      ...
      description: [
        'Developed website for TV Series using a custom, modified WordPress theme using JavaScript, HTML, CSS, and PHP',
